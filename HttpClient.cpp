 ...
 */
    ...
    int HttpClient::send_request(const std::function<int(HttpClient *, int, int, const char *)> &send_) {
 ...
 */
    ...
    uint8_t *HttpClient::recv_response(const std::function<int(HttpClient *, uint8_t *, int)> &recv_) {
